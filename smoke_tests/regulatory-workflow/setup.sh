...
$CLI init-mailbox --base runtime_mailbox --agent smoke-regwf-ra  --role requirements-analyst
$CLI init-mailbox --base runtime_mailbox --agent smoke-regwf-dev --role developer
$CLI init-mailbox --base runtime_mailbox --agent smoke-regwf-qa  --role qa
...
$CLI pack-workflow \
  --base runtime_mailbox --agent smoke-regwf-ra --role requirements-analyst --queue normal \
  ...
  --from smoke-regwf-ra_requirements-analyst \
  --to smoke-regwf-ra_requirements-analyst \
